# -------------------------------- Casen 2022 naive bayes --------------------------------#

#This script purpose is apply a naive bayes model to the casen 2022 data.
...
cat(capture.output(confusion),"\n",
    ...
    sep="\n",
    file="src\\models\\results\\casen_2022_naive_bayes_results.txt")

saveRDS(learner, 'src\\models\\results\\casen_2022_naive_bayes_learner.rds')
