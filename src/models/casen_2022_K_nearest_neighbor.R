# -------------------------------- Casen 2022 k nearest neighbors --------------------------------#

#This script purpose is apply a k-nearest neighbors to the casen 2022 data.
...
# Create a classification learner (k nearest neighbour)
...
cat(capture.output(confusion),"\n",
    ...
    sep="\n",
    file="src\\models\\results\\casen_2022_k_nearest_neighbors_results.txt")

saveRDS(learner, 'src\\models\\results\\casen_2022_k_nearest_neighbors_learner.rds')
