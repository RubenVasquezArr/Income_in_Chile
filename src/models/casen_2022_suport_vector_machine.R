# -------------------------------- Casen 2022 Support vector machine --------------------------------#

#This script purpose is apply a support vector machine to the casen 2022 data.
...
# Create a classification learner (svm)
...
cat(capture.output(confusion),"\n",
    ...
    sep="\n",
    file="src\\models\\results\\casen_2022_support_vector_machine_results.txt")

saveRDS(learner, 'src\\models\\results\\casen_2022_support_vector_machine_learner.rds')
